...
<div class="text-center">
		<div class="">
			<div class="col-sm-12">
				<b>F. Essa é uma loja de material de construção?</b>
				<br>
				<br>
				<br>
</div>
...
<!-- Opções de respostas-->		
<form id="cadastro" name="cadastro" method="post" action="cadastroperguntaf.php" onsubmit="return validaCampo(); return false;">	

		<input type="radio" name="pergunta_f" value="sim"> SIM<br>
        <input type="radio" name="pergunta_f" value="nao"> NÃO<br>
		<br>
